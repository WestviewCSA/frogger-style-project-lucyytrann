...
public class WoodScrolling2{
	...
	public WoodScrolling2() {
		forward 	= getImage("/imgs/"+"wood2.png"); //load the image for Tree
	...
	public WoodScrolling2(int x, int y) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = WoodScrolling2.class.getResource(path);
