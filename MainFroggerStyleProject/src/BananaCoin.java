...
public class BananaCoin{
	...
	public BananaCoin() {
		image 	= getImage("/imgs/"+"bananaCoin.gif"); //load the image for Tree
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = BananaCoin.class.getResource(path);
