...
public class SpiderScrolling2{
	...
	public SpiderScrolling2() {
		forward 	= getImage("/imgs/"+"spiderLeft1.png"); //load the image for Tree
	...
	public boolean collided(Monkey character) {
		Rectangle main = new Rectangle(character.getX(), character.getY(), 
									   character.getWidth(), character.getWidth());
	...
	public SpiderScrolling2(int x, int y) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = SpiderScrolling2.class.getResource(path);
